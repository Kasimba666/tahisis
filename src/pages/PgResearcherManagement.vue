<template>
  <div class="pg-researcher-management">
    <h3>Управление исследователями</h3>
    ...
    <div class="table-info">
      ...
      >
        <template #title>
          Всего исследователей: {{ tableData.length }}
        </template>
      </el-alert>
    </div>
    ...
    <div class="role-description">
      ...
      >
        <template #title>
          Роль «Исследователь» — просмотр данных и сохранение запросов к данным
        </template>
      </el-alert>
    </div>
      ...
      supabase
          ...
          .then(({ data, error }) => {
            if (error) {
              ...
              ElMessage.error('Ошибка загрузки исследователей')
              return
            }
            this.tableData = data || []
          })
